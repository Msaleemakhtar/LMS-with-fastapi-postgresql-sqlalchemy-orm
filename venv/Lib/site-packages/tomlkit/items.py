...
@overload
def item(
    value: bool, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Bool:
    ...
...
@overload
def item(
    value: int, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Integer:
    ...
...
@overload
def item(
    value: float, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Float:
    ...
...
@overload
def item(
    value: str, _parent: Item | None = ..., _sort_keys: bool = ...
) -> String:
    ...
...
@overload
def item(
    value: date, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Date:
    ...
...
@overload
def item(
    value: time, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Time:
    ...
...
@overload
def item(
    value: dict, _parent: Array = ..., _sort_keys: bool = ...
) -> InlineTable:
    ...
...
@overload
def item(
    value: dict, _parent: Item | None = ..., _sort_keys: bool = ...
) -> Table:
    ...
...
@overload
def item(
    value: ItemT, _parent: Item | None = ..., _sort_keys: bool = ...
) -> ItemT:
    ...


def item(
    value: Any, _parent: Item | None = None, _sort_keys: bool = False
) -> Item:
    ...
    if isinstance(value, bool):
        ...
        return Date(
            value.year, value.month, value.day, Trivia(), value.isoformat()
        )
...
class StringType(Enum):
    ...
    def escaped_sequences(self) -> Collection[str]:
        ...
        return {
            ...
            StringType.MLB: (escaped_in_basic | {'"""'})
            - allowed_in_multiline,
            StringType.SLL: (),
            StringType.MLL: (),
        }[self]
...
class _ArrayItemGroup:
    ...
    def __iter__(self) -> Iterator[Item]:
        return filter(
            ...
            (self.indent, self.value, self.comma, self.comment),
        )
...
class Array(Item, _CustomList):
    ...
    def __init__(
        ...
        list.__init__(
            ...
            [
                v
                for v in value
                if not isinstance(v, (Whitespace, Comment, Null))
            ],
        )
    ...
    def add_line(
        ...
        *items: Any,
        ...
        for i, el in enumerate(items):
            ...
            if (
                isinstance(it, Comment)
                or add_comma
                and isinstance(el, Whitespace)
            ):
                raise ValueError(
        ...
        if comment:
            ...
            new_values.append(
                Comment(
                    Trivia(indent=indent, comment=f"# {comment}", trail="")
                )
            )
    ...
    def insert(self, pos: int, value: Any) -> None:
        ...
        if idx > 0:
            ...
            if (
                not isinstance(last_item.value, Null)
                and "\n" in default_indent
            ):
...
class String(str, Item):
    ...
    def from_raw(cls, value: str, type_=StringType.SLB, escape=True) -> String:
        ...
        string_value = (
            escape_string(value, escaped) if escape and escaped else value
        )
