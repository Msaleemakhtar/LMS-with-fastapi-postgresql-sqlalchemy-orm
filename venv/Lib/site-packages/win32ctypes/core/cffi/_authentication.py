    ...
    def fromdict(cls, credential, flag=0):
        ...
        for key, value in credential.items():
            if key == "CredentialBlob":
                ...
                c_creds.CredentialBlobSize = ffi.sizeof(
                    blob_data
                ) - ffi.sizeof("wchar_t")
...
def _CredRead(TargetName, Type, Flags, ppCredential):
    ...
    return check_false(
        dlls.advapi32.CredReadW(target, Type, Flags, ppCredential), "CredRead"
    )
...
def _CredDelete(TargetName, Type, Flags):
    return check_false(
        dlls.advapi32.CredDeleteW(make_unicode(TargetName), Type, Flags),
        "CredDelete",
    )
