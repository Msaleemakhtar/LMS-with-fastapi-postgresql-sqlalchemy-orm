...
_LoadResource = function_factory(
    dlls.kernel32.LoadResource, [HMODULE, HRSRC], HGLOBAL, check_null
)

_LockResource = function_factory(
    dlls.kernel32.LockResource, [HGLOBAL], LPVOID, check_null
)

_SizeofResource = function_factory(
    dlls.kernel32.SizeofResource, [HMODULE, HRSRC], DWORD, check_zero
)

_BeginUpdateResource = function_factory(
    dlls.kernel32.BeginUpdateResourceW, [LPCWSTR, BOOL], HANDLE, check_null
)

_EndUpdateResource = function_factory(
    dlls.kernel32.EndUpdateResourceW, [HANDLE, BOOL], BOOL, check_false
)
