...
class Command(BaseCommand):
    ...
    def call_silent(self, name: str, args: str | None = None) -> int:
        ...
        return self.application._run_command(
            command, NullIO(StringInput(args or ""))
        )
    ...
    def secret(
        self, question: str | Question, default: Any | None = None
    ) -> Any:
        """
    ...
    def render_table(
        self, headers: str, rows: Rows, style: str | None = None
    ) -> None:
        """
