...
class TypeAdapter(Generic[T]):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            type_has_config = (
                issubclass(type, BaseModel)
                or is_dataclass(type)
                or is_typeddict(type)
            )
        except TypeError:
            # type is not a class
    ...
    def validate_json(
        ...
        *,
        ...
        return self.validator.validate_json(
            __data, strict=strict, context=context
        )
    ...
    def validate_strings(
        ...
        *,
        ...
        return self.validator.validate_strings(
            __obj, strict=strict, context=context
        )
    ...
    def json_schemas(
        ...
        *,
        ...
        inputs = [
            (key, mode, adapter.core_schema) for key, mode, adapter in __inputs
        ]

        (
            json_schemas_map,
            definitions,
        ) = schema_generator_instance.generate_definitions(inputs)
