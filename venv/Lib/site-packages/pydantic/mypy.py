...
class PydanticModelField:
    ...
    def expand_type(self, current_info: TypeInfo) -> Type | None:
        ...
        if (
            ...
            return expand_type(
                self.type,
                {self.info.self_type.id: fill_typevars(current_info)},
            )
        return self.type
    ...
    def collect_fields(
        ...
        for info in reversed(
            ...
            for name, data in info.metadata[METADATA_KEY]["fields"].items():
                ...
                with state.strict_optional_set(
                    self._api.options.strict_optional
                ):
    ...
    def add_initializer(
        ...
        with state.strict_optional_set(self._api.options.strict_optional):
            ...
            if is_root_model:
                ...
                args[0].kind = (
                    ARG_POS if args[0].kind == ARG_NAMED else ARG_OPT
                )
            ...
            if is_settings:
                ...
                if "__init__" in base_settings_node.names:
                    ...
                    if (
                        ...
                        for arg_idx, arg_name in enumerate(
                            func_type.arg_names
                        ):
