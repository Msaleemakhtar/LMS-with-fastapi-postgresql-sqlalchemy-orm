...
class GenerateJsonSchema:
    ...
    def date_schema(self, schema: core_schema.DateSchema) -> JsonSchemaValue:
        ...
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.date
        )
        return json_schema
    ...
    def tuple_positional_schema(
        self, schema: core_schema.TuplePositionalSchema
    ) -> JsonSchemaValue:
    ...
    def tuple_variable_schema(
        self, schema: core_schema.TupleVariableSchema
    ) -> JsonSchemaValue:
...
def model_json_schema(
    ...
    assert (
        "__pydantic_core_schema__" in cls.__dict__
