...
def pydantic_encoder(obj: Any) -> Any:
    ...
    warnings.warn(
        "pydantic_encoder is deprecated, use BaseModel.model_dump instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
@deprecated(
    "custom_pydantic_encoder is deprecated.",
    category=PydanticDeprecatedSince20,
)
...
@deprecated(
    "timedelta_isoformat is deprecated.", category=PydanticDeprecatedSince20
)
def timedelta_isoformat(td: datetime.timedelta) -> str:
    """ISO 8601 encoding for Python timedelta object."""
    warnings.warn(
        "timedelta_isoformat is deprecated.", DeprecationWarning, stacklevel=2
    )
