...
def set_dataclass_fields(
    cls: type[StandardDataclass], types_namespace: dict[str, Any] | None = None
) -> None:
    ...
    fields = collect_dataclass_fields(
        cls, types_namespace, typevars_map=typevars_map
    )
    ...
    *,
    ...
    if config_wrapper.validate_assignment:
        ...
        def validated_setattr(
            instance: Any, __field: str, __value: str
        ) -> None:
...
def process_param_defaults(param: Parameter) -> Parameter:
    ...
    if isinstance(param_default, FieldInfo):
        ...
        if (
            validation_alias is None
            and isinstance(alias, str)
            and is_valid_identifier(alias)
        ):
            name = alias
        elif isinstance(validation_alias, str) and is_valid_identifier(
            validation_alias
        ):
...
def generate_dataclass_signature(
    ...
    return generate_pydantic_signature(
        ...
        post_process_parameter=process_param_defaults,
    )
