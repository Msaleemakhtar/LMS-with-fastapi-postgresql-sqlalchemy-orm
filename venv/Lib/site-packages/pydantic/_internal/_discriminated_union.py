...
def apply_discriminators(
    ...
    return simplify_schema_references(
        _core_utils.walk_core_schema(schema, inner)
    )
    ...
    def apply(self, schema: core_schema.CoreSchema) -> core_schema.CoreSchema:
        ...
        if missing_defs:
            schema = core_schema.definitions_schema(
                schema, [self.definitions[ref] for ref in missing_defs]
            )
        return schema
