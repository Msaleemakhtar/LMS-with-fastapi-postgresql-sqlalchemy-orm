...
class SchemaValidator:
    ...
    def __new__(
        cls, schema: CoreSchema, config: CoreConfig | None = None
    ) -> Self:
        """
    ...
    def validate_assignment(
        ...
        *,
        ...
        dict[str, Any], dict[str, Any] | None, set[str]
    ]:
        """
...
_IncEx: TypeAlias = (
    set[int] | set[str] | dict[int, _IncEx] | dict[str, _IncEx] | None
)
...
def from_json(
    data: str | bytes | bytearray, *, allow_inf_nan: bool = True
) -> Any:
    """
