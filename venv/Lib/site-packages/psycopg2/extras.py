...
class RealDictConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        kwargs.setdefault(
            "cursor_factory", self.cursor_factory or RealDictCursor
        )
        return super().cursor(*args, **kwargs)
...
class NamedTupleConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        kwargs.setdefault(
            "cursor_factory", self.cursor_factory or NamedTupleCursor
        )
        return super().cursor(*args, **kwargs)
...
class LoggingConnection(_connection):
    ...
    def cursor(self, *args, **kwargs):
        self._check()
        kwargs.setdefault(
            "cursor_factory", self.cursor_factory or LoggingCursor
        )
        return super().cursor(*args, **kwargs)
...
class MinTimeLoggingConnection(LoggingConnection):
    ...
    def cursor(self, *args, **kwargs):
        kwargs.setdefault(
            "cursor_factory", self.cursor_factory or MinTimeLoggingCursor
        )
...
"""
        ...
        return self(
            tname, type_oid, type_attrs, array_oid=array_oid, schema=schema
        )
...
def register_composite(name, conn_or_curs, globally=False, factory=None):
    ...
    _ext.register_type(
        caster.typecaster, not globally and conn_or_curs or None
    )
...
def execute_values(
    cur, sql, argslist, template=None, page_size=100, fetch=False
):
