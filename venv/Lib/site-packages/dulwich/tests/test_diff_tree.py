...
class TreeChangesTest(DiffTestCase):
    ...
    def _do_test_merge_entries(self, merge_entries):
        ...
        self.assertEqual(
            [], merge_entries(b"", self.empty_tree, self.empty_tree)
        )
        self.assertEqual(
            [
    ...
    def test_tree_changes_no_changes(self):
        ...
        self.assertChangesEqual(
            [
                TreeChange(
                    CHANGE_UNCHANGED, (b"a", F, blob.id), (b"a", F, blob.id)
                ),
                TreeChange(
                    CHANGE_UNCHANGED,
                    (b"b/c", F, blob.id),
    ...
    def test_tree_changes_rename_detector(self):
        ...
        self.assertChangesEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob_a1.id), (b"c", F, blob_a2.id)
                )
            ],
            tree1,
            tree2,
        ...
        self.assertChangesForMergeEqual(
            [
                [
                    ...
                    TreeChange(
                        CHANGE_MODIFY, (b"a", F, blob1.id), (b"a", F, blob2.id)
                    ),
                ]
            ],
            [parent1, parent2],
    ...
    def test_tree_changes_for_merge_modify_modify_conflict(self):
        ...
        self.assertChangesForMergeEqual(
            [
                [
                    TreeChange(
                        CHANGE_MODIFY, (b"a", F, blob1.id), (b"a", F, blob3.id)
                    ),
                    TreeChange(
    ...
    def test_tree_changes_for_merge_add_content_rename_conflict(self):
        ...
        self.assertChangesForMergeEqual(
            [
                [
                    TreeChange(
                        CHANGE_RENAME, (b"a", F, blob1.id), (b"b", F, blob2.id)
                    ),
...
class RenameDetectionTest(DiffTestCase):
    ...
    def test_no_renames(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_MODIFY, (b"b", F, blob2.id), (b"b", F, blob3.id)
                )
            ],
    ...
    def test_exact_rename_one_to_one(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"c", F, blob1.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob2.id), (b"d", F, blob2.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_exact_rename_and_different_type(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"b", F, blob1.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_exact_rename_one_to_many(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob.id), (b"c", F, blob.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_exact_rename_many_to_one(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob.id), (b"c", F, blob.id)
                ),
    ...
    def test_exact_rename_many_to_many(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob.id), (b"e", F, blob.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob.id), (b"d", F, blob.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_exact_copy_modify(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob1.id), (b"b", F, blob1.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_exact_copy_change_mode(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob.id), (b"b", F, blob.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_content_rename_max_files(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"d", F, blob4.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob2.id), (b"c", F, blob3.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_content_rename_one_to_one(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, b11.id), (b"c", F, b12.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, b21.id), (b"d", F, b22.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_content_rename_one_to_one_ordering(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob2.id), (b"c", F, blob3.id)
                ),
    ...
    def test_content_rename_one_to_many(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"c", F, blob3.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
    ...
    def test_content_rename_many_to_many(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob1.id), (b"d", F, blob4.id)
                ),
                TreeChange.delete((b"b", F, blob2.id)),
            ],
            self.detect_renames(tree1, tree2),
    ...
    def test_content_rename_with_more_deletions(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"e", F, blob1.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob1.id), (b"f", F, blob1.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"c", F, blob1.id), (b"g", F, blob1.id)
                ),
    ...
    def test_exact_rename_swap(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_MODIFY, (b"b", F, blob2.id), (b"b", F, blob1.id)
                ),
            ],
            self.detect_renames(tree1, tree2),
        )
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob2.id), (b"a", F, blob2.id)
                ),
            ],
    ...
    def test_content_rename_swap(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob1.id), (b"b", F, blob3.id)
                ),
                TreeChange(
                    CHANGE_RENAME, (b"b", F, blob2.id), (b"a", F, blob4.id)
                ),
            ],
    ...
    def test_find_copies_harder_with_rewrites(self):
        ...
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_COPY, (b"a", F, blob_a1.id), (b"b", F, blob_b2.id)
                ),
            ],
            self.detect_renames(tree1, tree2, find_copies_harder=True),
        )
        self.assertEqual(
            [
                ...
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob_a1.id), (b"b", F, blob_b2.id)
                ),
            ],
            self.detect_renames(
    ...
    def test_want_unchanged(self):
        ...
        self.assertEqual(
            [
                TreeChange(
                    CHANGE_RENAME, (b"a", F, blob_a1.id), (b"c", F, blob_c2.id)
                )
            ],
            self.detect_renames(tree1, tree2),
        )
