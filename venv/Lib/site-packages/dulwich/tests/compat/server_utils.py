...
class ServerTests:
    ...
    def test_push_to_dulwich_remove_branch(self):
        ...
        run_git_or_fail(
            ["push", self.url(port), ":master"], cwd=self._new_repo.path
        )
    ...
    def test_clone_from_dulwich_empty(self):
        ...
        run_git_or_fail(
            ["clone", self.url(port), new_repo_dir], cwd=new_repo_base_dir
        )
    ...
    def test_fetch_from_dulwich_issue_88_standard(self):
        ...
        run_git_or_fail(
            ["fetch", self.url(port), "master"], cwd=self._client_repo.path
        )
    ...
    def test_push_to_dulwich_issue_88_standard(self):
        ...
        run_git_or_fail(
            ["push", self.url(port), "master"], cwd=self._client_repo.path
        )
