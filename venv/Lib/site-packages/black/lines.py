...
class EmptyLineTracker:
    ...
    def maybe_empty_lines(self, current_line: Line) -> LinesBlock:
        ...
        previous_after = (
            self.previous_block.after if self.previous_block else 0
        )
        before = (
    ...
    def _maybe_empty_lines(self, current_line: Line) -> Tuple[int, int]:
        ...
        if (
            ...
            if (
                Preview.no_blank_line_before_class_docstring
...
def is_line_short_enough(  # noqa: C901
    ...
    max_level_to_update: Union[
        int, float
    ] = math.inf  # track the depth of the MLS
    for i, leaf in enumerate(line.leaves):
        ...
        if (
            leaf.bracket_depth <= max_level_to_update
            ...
            if not (
                leaf.prev_sibling in ignore_ctxs and i == len(line.leaves) - 1
            ):
