...
class InfoCommon:
    ...
    def _already_tagged(self, version: str) -> bool:
        ...
        return version.endswith(self.vtags) or version.endswith(
            self._safe_tags()
        )
...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self):
        ...
        self.egg_info = (
            _normalization.filename_component(self.egg_name) + ".egg-info"
        )
...
class FileList(_FileList):
    ...
    def process_template_line(self, line):
        ...
        try:
            ...
            raise DistutilsInternalError(
                "this cannot happen: invalid action '{action!s}'".format(
                    action=action
                ),
            )
    ...
    def recursive_include(self, dir, pattern):
        ...
        found = [
            f
            for f in glob(full_pattern, recursive=True)
