...
# 3.6.0-3.6.1
    ...
    from _collections_abc import (
        _check_methods as _check_methods_in_mro,
    )  # noqa
    ...
    class OrderedDict(
        ...
        def __new__(cls, *args, **kwds):
            ...
            return typing._generic_new(
                collections.OrderedDict, cls, *args, **kwds
            )
                ...
                if gvars is None:
                    ...
                    if not tvarset <= gvarset:
                        ...
                        cls_name = (
                            "Generic"
                            if any(
                                b.__origin__ is typing.Generic for b in bases
                            )
                            else "Protocol"
                        )
                        raise TypeError(
...
if sys.version_info >= (3, 9, 2):
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, total=True):
            ...
            # via _dict_new.
            ns["__new__"] = (
                _typeddict_new if name == "TypedDict" else _dict_new
            )
...
# 3.6
    ...
    class _TypeAliasBase(
        typing._FinalTypingBase, metaclass=_TypeAliasMeta, _root=True
    ):
        """Special marker indicating that an assignment should
        be recognized as a proper type alias definition by type
        checkers.
...
# 3.6-3.9
    ...
    class ParamSpec(list):
        ...
        def __init__(
            self, name, *, bound=None, covariant=False, contravariant=False
        ):
            super().__init__([self])
            self.__name__ = name
        ...
        def __getitem__(self, item):
            ...
            if self.__type__ is None:
                return cls(
                    typing._type_check(
                        item,
                        "{} accepts only single type.".format(
                            cls.__name__[1:]
                        ),
                    ),
                    _root=True,
