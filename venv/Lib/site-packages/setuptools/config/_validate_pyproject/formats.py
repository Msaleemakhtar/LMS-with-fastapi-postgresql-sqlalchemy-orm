...
def pep517_backend_reference(value: str) -> bool:
    ...
    identifiers = (
        i.strip() for i in _chain(module.split("."), obj.split("."))
    )
...
class _TroveClassifier:
    ...
    def __call__(self, value: str) -> bool:
        ...
        return value in self.downloaded or value.lower().startswith(
            "private ::"
        )
...
try:
    ...
    def trove_classifier(value: str) -> bool:
        return value in _trove_classifiers or value.lower().startswith(
            "private ::"
        )
