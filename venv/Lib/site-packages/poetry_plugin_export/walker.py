...
def get_python_version_region_markers(
    packages: list[Package],
) -> list[BaseMarker]:
    markers = []

    regions = constraint_regions(
        [package.python_constraint for package in packages]
    )
    ...
    while dependencies:
        ...
        if key not in nested_dependencies:
            ...
            nested_dependencies[key].marker = nested_dependencies[
                key
            ].marker.union(requirement.marker)
