...
class PartialSolution:
    ...
    def decide(self, package: Package) -> None:
        ...
        self._assign(
            Assignment.decision(
                package, self.decision_level, len(self._assignments)
            )
        )
    ...
    def _register(self, assignment: Assignment) -> None:
        ...
        term = (
            ...
            else assignment.intersect(old_negative)
        )
    ...
    def satisfier(self, term: Term) -> Assignment:
        ...
        for assignment in self._assignments:
            if (
                assignment.dependency.complete_name
                != term.dependency.complete_name
            ):
                continue
