...
lalr_argparser.add_argument(
    "-o",
    "--out",
    type=FileType("w", encoding=encoding),
    default=sys.stdout,
    help="the output file (default=stdout)",
)
lalr_argparser.add_argument(
    "grammar_file",
    type=FileType("r", encoding=encoding),
    help="A valid .lark file",
)
...
for flag in flags:
    if isinstance(flag, tuple):
        ...
        lalr_argparser.add_argument(
            "-" + flag[0], "--" + flag[1], action="store_true"
        )
        ...
        raise NotImplementedError(
            "flags must only contain strings or tuples of strings"
        )
