...
class Lark(Serialize):
    ...
    def __init__(
            ...
            if self.options.cache:
                ...
                try:
                    with FS.open(cache_fn, "rb") as f:
                        logger.debug(
                            "Loading grammar from cache: %s", cache_fn
                        )
        ...
        if isinstance(lexer, type):
            ...
            assert_config(
                lexer, ("basic", "contextual", "dynamic", "dynamic_complete")
            )
        ...
        if cache_fn:
            ...
            try:
                ...
                logger.exception(
                    "Failed to save Lark to cache: %r.", cache_fn, e
                )
    ...
    def _build_parser(self) -> "ParsingFrontend":
        ...
        parser_conf = ParserConf(
            self.rules, self._callbacks, self.options.start
        )
    ...
    def save(self, f, exclude_options: Collection[str] = ()) -> None:
        ...
        if exclude_options:
            data["options"] = {
                ...
                if n not in exclude_options
            }
        pickle.dump(
            {"data": data, "memo": m}, f, protocol=pickle.HIGHEST_PROTOCOL
        )
