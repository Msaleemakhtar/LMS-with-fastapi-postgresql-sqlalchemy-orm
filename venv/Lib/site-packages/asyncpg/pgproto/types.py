...
class BitString:
    ...
    def __init__(
        self, bitstring: typing.Optional[builtins.bytes] = None
    ) -> None:
        if not bitstring:
            self._bytes = bytes()
            self._bitlength = 0
    ...
    def frombytes(
        ...
        bitlength: typing.Optional[int] = None,
    ) -> _BitString:
    ...
    def to_int(
        self, bitorder: _BitOrderType = "big", *, signed: bool = False
    ) -> int:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self._bytes == other._bytes and self._bitlength == other._bitlength
        )
...
class Point(typing.Tuple[float, float]):
    ...
    def __new__(
        ...
        return super().__new__(
            cls, typing.cast(typing.Any, (float(x), float(y)))
        )

    def __repr__(self) -> str:
        return "{}.{}({})".format(
            type(self).__module__, type(self).__name__, tuple.__repr__(self)
        )
...
class Box(typing.Tuple[Point, Point]):
    ...
    def __new__(
        ...
        return super().__new__(
            cls, typing.cast(typing.Any, (Point(*high), Point(*low)))
        )
...
class LineSegment(typing.Tuple[Point, Point]):
    ...
    def __new__(
        ...
        return super().__new__(
            cls, typing.cast(typing.Any, (Point(*p1), Point(*p2)))
        )
...
class Path:
    ...
    def __init__(
        self, *points: typing.Sequence[float], is_closed: bool = False
    ) -> None:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            self.points == other.points and self._is_closed == other._is_closed
        )
